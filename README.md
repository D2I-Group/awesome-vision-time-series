...
* [2025] [NeurIPS] A Diffusion Model for Regular Time Series Generation from Irregular Data with Completion and Masking [[paper](https://openreview.net/pdf?id=M9JmlA6Cgf)][[arxiv](https://arxiv.org/abs/2510.06699)][[code](https://github.com/azencot-group/ImagenI2R)]
* [2025] [NeurIPS] Multi-Modal View Enhanced Large Vision Models for Long-Term Time Series Forecasting [[paper](https://openreview.net/pdf/c03b46e53aba341582e8525a457a5893c8c3f9a5.pdf)][[arxiv](https://arxiv.org/abs/2505.24003)][[code](https://github.com/D2I-Group/dmmv)]
* [2025] [NeurIPS] GEM: Empowering MLLM for Grounded ECG Understanding with Time Series and Images [[paper](https://openreview.net/pdf/2b55553f2233d0f89ea4e560834a4bf40fa11f41.pdf)][[arxiv](https://arxiv.org/abs/2503.06073)][[code](https://github.com/lanxiang1017/GEM)]
* [2025] [NeurIPS Workshop] TimeMaster: Training Time-Series Multimodal LLMs to Reason via Reinforcement Learning [[paper](https://openreview.net/pdf?id=BaID9Ta6Ew)][[arxiv](https://arxiv.org/abs/2506.13705)][[code](https://github.com/langfengQ/TimeMaster)]
